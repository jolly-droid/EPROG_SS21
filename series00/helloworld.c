...
/*semicolon in zeile 5 weg - fehlermedlung, da zeile nicht abgeschlossen, compiler fehler
 ...
 * Intialisierung: Wert zuweisen
 * Deklaration: Nur Namen/Speicherplatz zuweisen
 *
 * int x; dekl
 * x = 5; init
 */
